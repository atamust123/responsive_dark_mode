    ...
    <div className="flex p-16">
      ...
      <div className="w-1/2 flex flex-row">
        ...
        <div className="w-1/2">
          ...
          <ul className="text-end">
            <li className="mt-4">
              <a href="tel:+90 549 505 19 90">+90 549 505 19 90</a>
            </li>
            <li className="mt-4 w-full ml-auto">
              Demirtaş mahallesi İnönü Caddesi No:143/1 Bursa/Osmangazi
            </li>
            <li className="mt-4">
              <a href="mailto:info@adesahome.com">info@adesahome.com</a>
            </li>
          </ul>
        </div>
      </div>
